...
async def list_studying_books(session: Session = Depends(get_db), user: User = Depends(get_current_user)):
...
async def individual_studying_book(id: int, session: Session = Depends(get_db), user: User = Depends(get_current_user)):
...
async def create_studying_book(req_body: CreateStudyingBook, session: Session = Depends(get_db), user: User = Depends(get_current_user)):
...
async def delete_studying_book(id: int, session: Session = Depends(get_db), user: User = Depends(get_current_user)):
...
async def create_studying_book_record(id: int, req_body: CreateStudyingBookRecord, session: Session = Depends(get_db), user: User = Depends(get_current_user)):
