...
async def study_book_progress(session: Session = Depends(get_db), user = Depends(get_current_user)):
...
async def study_times(session: Session = Depends(get_db), user = Depends(get_current_user)):
...
async def book_counts(session: Session = Depends(get_db), user = Depends(get_current_user)):
